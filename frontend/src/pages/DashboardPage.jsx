...
// Get current hour from user's system
...
// Get last login from browser storage.
// If it doesn't exist, show current date and time.
const lastLogin =
  ...
  return (
    <div className="dashboard">
      <div className="dashboard-header">
        <div>
          <h1 className="dashboard-greeting"> {greeting}, {displayName.split(' ')[0]}</h1>
